app.controller("RedundancyReportController", ['$scope', '$rootScope',
 ...
 $scope.showPrintModal = function(councils) {
    ...
    var modalInstance = $uibModal.open({
      templateUrl: "/templates/nurses/redundancy.html",
      size: 'lg',
      controller: ['$scope', '$uibModalInstance', 'toastr', '$state', 'API',
        ...
        API.getLossReduncy("day", time, "redundancy").success(function (response) {
          NProgress.done();
          if(response.code == 1) {
            $scope.redundancy = response.data;
          } else {
